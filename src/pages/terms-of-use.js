...
const TermsOfUse = () => (
  <Layout>
    ...
    <PageLayout title="Terms of Use">
      ...
      <h2>Welcome to Travel Biryani</h2>
      <p>These terms and conditions outline the rules and regulations for the use of Travel Biryani's Website.</p>

      <p>By accessing this website we assume you accept these terms and conditions in full. Do not continue to use Travel Biryani's website 
      ...
      <p>We employ the use of cookies. By using Travel Biryani's website you consent to the use of cookies 
      in accordance with Travel Biryani's privacy policy.</p><p>Most of the modern day interactive web sites
      use cookies to enable us to retrieve user details for each visit. Cookies are used in some areas of our site
      to enable the functionality of this area and ease of use for those people visiting. Some of our 
      affiliate / advertising partners may also use cookies.</p><h2>License</h2>
      <p>Unless otherwise stated, Travel Biryani and/or it's licensors own the intellectual property rights for
      all material on Travel Biryani. All intellectual property rights are reserved. You may view and/or print
      pages from https://travelbiryani.com/ for your own personal use subject to restrictions set in these terms and conditions.</p>
      <p>You must not:</p>
      <ol>
        <li>Republish material from https://travelbiryani.com/</li>
        <li>Sell, rent or sub-license material from https://travelbiryani.com/</li>
        <li>Reproduce, duplicate or copy material from https://travelbiryani.com/</li>
      </ol>
      <p>Redistribute content from Travel Biryani (unless content is specifically made for redistribution).</p>
      
      <h2>User Comments</h2>
      <ol>
        <li>This Agreement shall begin on the date hereof.</li>
        <li>Certain parts of this website offer the opportunity for users to post and exchange opinions, information,
        material and data ('Comments') in areas of the website. Travel Biryani does not screen, edit, publish
        or review Comments prior to their appearance on the website and Comments do not reflect the views or
        opinions of Travel Biryani, its agents or affiliates. Comments reflect the view and opinion of the
        person who posts such view or opinion. To the extent permitted by applicable laws Travel Biryani shall
        ...
        website.</li>
        <li>Travel Biryani reserves the right to monitor all Comments and to remove any Comments which it considers
        ...
        <li>You hereby grant to <strong>Travel Biryani</strong> a non-exclusive royalty-free license to use, reproduce,
      ...
      you must notify us by sending an e-mail to <a href="mailto:admin@travelbiryani.com" title="send an email to admin@travelbiryani.com">admin@travelbiryani.com</a>.
      ...
      <p>No use of Travel Biryani's logo or other artwork will be allowed for linking absent a trademark license
      agreement.</p>
